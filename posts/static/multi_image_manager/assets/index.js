...
function MainImageUploader() {
  ...
  function handleDeleteImage() {
    setImage(null);
    document.getElementById("django_main_image_deleted_hidden_input").value = "true";
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "1rem" }, children: [
...
function AdditionalImagesUploader() {
  ...
  const [images, setImages] = reactExports.useState(
    Array.from(
      ((_a = document.getElementById("django_multi_image_hidden_input")) == null ? void 0 : _a.getAttribute("initial_values")) ? JSON.parse(
        JSON.parse(
          document.getElementById("django_multi_image_hidden_input").getAttribute("initial_values")
        )
      ) : []
    )
  );
  ...
  reactExports.useEffect(() => {
    ...
    for (let file of images) {
      if (!(file instanceof File) && (file == null ? void 0 : file.url)) {
    ...
    if (djangoMultiImageHiddentInput) {
      ...
      document.getElementById("django_multi_image_hidden_input").files = dataTransfer.files;
    }
  }, [images, setImages]);
  reactExports.useEffect(() => {
...
client.createRoot(document.getElementById("multi_image_manager_root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "1rem" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(MainImageUploader, {}),
